...
public interface IProductRepository
{
    ...
    Task<(IReadOnlyList<Product> Items, long Total)> SearchAsync(ProductSearchCriteria criteria, CancellationToken ct = default);
    Task<IReadOnlyList<Product>>             GetByIdsAsync(IReadOnlyList<ProductId> ids, CancellationToken ct = default);
